...
<ul dir="auto">
<li>Criar um contêiner apartir do docker-compose.yml.<br></li>
<li>Edite o arquivo .env conforme a sua necessidade.<br></li>
<li>Comando para criar o contêiner:<br>
 docker compose -f docker-compose.yml up --build -d <br>
<li>Certifique-se de estar na pasta onde o docker-compose.yml está</li>	
</li>
